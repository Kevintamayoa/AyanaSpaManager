...
public class FlujoGrupo extends JFrame implements ActionListener{
  ...
  public FlujoGrupo() {
    super( "Flujo Económico de Grupo Ayana Spa" );
       con=new Conexion();
       con.Conectar();  
         try{
  ...
  saldoinicial=saldoinicial2019;
       ...
       int mes=flujo.get(i).Month-1;
            ...
            ingresos[incomestype.size()][mes][0]+=flujo.get(i).Product2();
                  ingresos[incomestype.size()][12][0]+=flujo.get(i).Product2();
                     ingresos[incomestype.size()+1][mes][0]+=flujo.get(i).Giftcard2();
                  ingresos[incomestype.size()+1][12][0]+=flujo.get(i).Giftcard2();
                     ingresos[incomestype.size()+2][mes][0]+=flujo.get(i).Facial2();
                  ingresos[incomestype.size()+2][12][0]+=flujo.get(i).Facial2();
                     ingresos[incomestype.size()+3][mes][0]+=flujo.get(i).BTL2();
                  ingresos[incomestype.size()+3][12][0]+=flujo.get(i).BTL2();
                     ingresos[incomestype.size()+4][mes][0]+=flujo.get(i).Masaje2();
                  ingresos[incomestype.size()+4][12][0]+=flujo.get(i).Masaje2();
               ingresos[incomestype.size()+5][mes][0]+=flujo.get(i).Medico2();
                  ingresos[incomestype.size()+5][12][0]+=flujo.get(i).Medico2();
       }
