 ...
 * @author macbook
 */
public class AddSaleService extends javax.swing.JDialog {

    /**
     * Creates new form AddSaleService
     */
      ...
      Icon  fondo = new ImageIcon(imagen.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH));
        ...
        MontoProduct=0;
          con=new Conexion();
           con.Conectar();
          try {
        inventory_type=con.GetServiceType();
       sale_inventory=con.GetSaleServicesBySale(Save.Sale2.Id);
        } catch (SQLException ex) {}     
        con.Desconectar();
        
        for(Service_Type obj : inventory_type){
...
JTextField text2 = (JTextField)cbxProducto.getEditor().getEditorComponent();
 ...
 Conexion con;
    ...
    List<Sale_Service> sale_inventory;
List<Service_Type> inventory_type;
double MontoProduct;
...
Vector vectorProveedor = new Vector();
    ...
    private void initComponents() {
        ...
        setTitle("Agregar servicio a la venta");
        setResizable(false);
        ...
        jLabel12.setText("Agregar servicio a venta");
        ...
        jLabel1.setFont(new java.awt.Font("InaiMathi", 0, 12)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(102, 102, 102));
        jLabel1.setText("Precio individual");

        jLabel2.setFont(new java.awt.Font("InaiMathi", 0, 12)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Contacto, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnCapturaEgresosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapturaEgresosActionPerformed
       try{
            ...
            Service_Type producto = inventory_type.stream()
            ...
            .orElse(null);
                ...
                try{
                    con=new Conexion();
                    con.Conectar();
                    con.AddSaleService(new Sale_Service(0,producto.Id,Save.Sale2.Id,Integer.parseInt(nupCantidad.getValue().toString()),MontoProduct));
                    con.Desconectar();}catch (SQLException ex) {}
                con.Desconectar();
                JOptionPane.showMessageDialog(this,"Servicio agregado a venta con éxito.");
                this.dispose();

        }catch(Exception e){
             JOptionPane.showMessageDialog(this,"Servicio no existente.","Error",JOptionPane.ERROR_MESSAGE);
       }finally{}
    ...
    private void cbxProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxProductoActionPerformed
        try {
            ...
            .findAny()
            .orElse(null);
            jButton1.setText(""+producto.Price);
           
             jButton2.setText(""+producto.Cost1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       try {
            ...
            .findAny()
            .orElse(null);
               MontoProduct=producto.Cost1*Double.parseDouble(nupCantidad.getValue().toString());
            txtMontoProducto.setText(""+MontoProduct);
            } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddSaleService.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddSaleService().setVisible(true);
            }
        });
    }
