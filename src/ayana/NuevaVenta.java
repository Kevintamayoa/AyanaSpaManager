...
Vector vectorCuenta = new Vector();
 ...
 private DefaultTableModel modelServicios;
    ...
    private void initComponents() {
        ...
        tablePago.setBackground(new java.awt.Color(253, 239, 229));
        ...
        tablePago.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Cuenta", "Monto sin IVA", "IVA", "Monto ", "Amount"
            }
        ) {
        ...
        if (tablePago.getColumnModel().getColumnCount() > 0) {
            ...
            tablePago.getColumnModel().getColumn(5).setMinWidth(0);
            tablePago.getColumnModel().getColumn(5).setPreferredWidth(0);
            tablePago.getColumnModel().getColumn(5).setMaxWidth(0);
        }
        ...
        txtMontoPago.setBackground(new java.awt.Color(255, 248, 245));
        ...
        txtFactura.setBackground(new java.awt.Color(255, 248, 245));
                ...
                .addGroup(panel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panel2Layout.createSequentialGroup()
                        ...
                        .addGroup(panel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cbxCliente, 0, 310, Short.MAX_VALUE)
                            .addComponent(dtDate, javax.swing.GroupLayout.DEFAULT_SIZE, 310, Short.MAX_VALUE)
        ...
        cbxServicio.setBackground(new java.awt.Color(255, 248, 245));
        ...
        txtMontoServicio.setBackground(new java.awt.Color(255, 248, 245));
  ...
  .orElse(null);
    ...
    {
        sale_inventory.add(new Sale_Inventory(producto.Id,Integer.parseInt(nupCantidad.getValue().toString()),MontoProduct));
...
JOptionPane.YES_NO_OPTION);
   if(n==JOptionPane.YES_OPTION){
      con=new Conexion();
        con.Conectar();   
        Sale sale=new Sale(dtDate.getDate(),clienteid,txtComentarios.getText(),MontoTotal);
        try{
  ...
  .orElse(null);
        ...
        sale_services.add(new Sale_Service(service.Id,Integer.parseInt(nupCantidad1.getValue().toString()),MontoService));
        modelServicios.addRow(new Object[]{service.Id,service.Description,Integer.parseInt(nupCantidad1.getValue().toString()),formatea.format(MontoService)});
  ...
  .orElse(null);
     ...
     if(checkFactura.isSelected()){
        ...
        modelPagos.addRow(new Object[]{account.Id,account.Description,formatea.format(siniva),checkFactura.isSelected(),formatea.format(MontoPago)});
 ...
 try {
    ...
    private javax.swing.JSpinner nupCantidad1;
