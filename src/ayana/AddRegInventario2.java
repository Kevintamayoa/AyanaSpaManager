 ...
 * @author macbook
 */
public class AddRegInventario2 extends javax.swing.JDialog {

    /** Creates new form AddRegInventario2 */
    public AddRegInventario2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Agregar producto a pedido");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddRegInventario2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddRegInventario2().setVisible(true);
            }
        });
    }
