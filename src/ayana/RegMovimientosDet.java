...
TableRowSorter trs;
    ...
    private void initComponents() {
        ...
        setTitle("Registro detallado de movimientos de inventario");
        ...
        cbxFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Producto", "Salida", "Entrada", "Cantidad" }));
        ...
        jLabel5.setText("Registro detallado de movimientos de inventario");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Producto", "Salida", "Entrada", "Cantidad", "Merma"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Boolean.class
            };
...
JOptionPane.YES_NO_OPTION);
   if(n==JOptionPane.YES_OPTION){
        ...
        con.Conectar();        
     try{
          request3=con.GetInventoryMovesByRegId3(Integer.parseInt(table.getValueAt(table.getSelectedRow(), 0).toString()));
     ...
     boolean nel=false;
         ...
         if(request3.CabinaStock<0||request3.TotalStock<0||request3.PuntoVentaStock<0){
             nel=true;
         }
